...
(define value-of
  (lambda (Exp1 env)
    (cases Exp Exp1
      ...
      #|(begin-Exp (exp1 expps)
          (value-of (letrec-Exp
                     (list 'value-of-begins)
                     (list (list 'exp 'expps))
                     (list (if-Exp
                            (null? expps)
                            (value-of 'exp env)
                            (call-Exp (var-Exp 'value-of-begins) (list (car expps) (cdr expps)))))
                     (call-Exp (var-Exp 'value-of-begins) (list exp1 expps))) env))|#
      (zero-Exp? (Exp1)
            ...
            ((value-of-begins
               (lambda (exp exps)
                 (let ((v1 (value-of exp env)))
                   (if (null? exps)
                     v1
                     (value-of-begins (car exps) (cdr exps)))))))
            (value-of-begins exp1 expps)))
      (newref-Exp (exp1)
